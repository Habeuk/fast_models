 ...
 *  library = "fast_models/vesper_service_card",
...
class VesperServiceCard extends FormatageModelsTeasers {
    ...
    public function __construct(array $configuration, $plugin_id, $plugin_definition, StylesGroupManager $styles_group_manager) {
        ...
        $this->pluginDefinition->set('icon', $this->pathResolver->getPath('module', 'fast_models') . "/icons/teasers/vesper-card-service.png");
    }
