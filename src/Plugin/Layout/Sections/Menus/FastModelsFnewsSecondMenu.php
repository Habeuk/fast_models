...
class FastModelsFnewsSecondMenu extends FormatageModelsSection {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, StylesGroupManager $styles_group_manager) {
    ...
    $this->pluginDefinition->set('icon', $this->pathResolver->getPath('module', 'fast_models') . "/icons/menus/fast_models_fn_second_menu_map.png");
  }
  ...
  public function defaultConfiguration() {
    return [
      ...
      'derivate' => [
        ...
        'options' => [
          'default' => 'default',
          'second-nav--fixed' => 'menu statique'
        ]
      ],
      'fmfsm' => [
        'builder-form' => true,
